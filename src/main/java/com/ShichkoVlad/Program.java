//TODO
// Вернуть логгер
// Снести коллекции + библиотеку
// Добавить класс работы с бд (добавить, удалить, поиск, редактировать). В метод передается объект и имя таблица, возвращает успешность операции
